...
This AEP describes the choice and gives a global view to redesigning ArmoniK's infrastructure.

# Motivation

The motivation behind redesigning the infrastructure is to have an infrastructure that is light, modular and easy to maintain. By standardizing the expected outputs for the various modules, switching from one technology vendor to another will be easy.
...
Component outputs should be like that:
